(function(){
  ...
  register('rc_speculative',  { tier: 4, theme: 'compute',  parents: ['r_parallel_cores'],  cost: 200, threads: 3, exotic: true, changerNode: true, label: 'speculative execution', desc: 'ADAPTATION: a crash commits its work instead of halting you', grant: { changer: 'speculative_exec' } });
