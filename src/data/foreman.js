(function(){
  ...
  const NODES = [
    ...
    { id: 'fb_install',kind: 'facility', name: 'install rig', desc: 'the unit seats every machine you buy automatically — no idle crates.',
      cost: 14000, buildSec: 70, requires: { nodes: ['fb_fab'] }, effect: { auto: 'install' } },
    { id: 'fb_salvage',kind: 'facility', name: 'teardown bay', desc: 'it strips dead/seized machines for parts — sales return more.',
